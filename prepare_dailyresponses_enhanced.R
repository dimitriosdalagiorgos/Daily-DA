...
# 2. Re-adjusts rankings after removals
# 3. Removes students listed in students_to_remove.csv
# 4. Outputs dailyresponses_clean.csv
# ----------------------------------------------------------
...
# --- Step 2: Remove selected clubs ---
clubs_to_delete <- clubs_to_remove$club_name
clubs_to_delete <- trimws(tolower(clubs_to_delete))
